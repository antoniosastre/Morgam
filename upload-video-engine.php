...
if(rename($inbox_dir.$_POST['video'], $target_file)){
	...
	$idinsertedmedia = insertVideoInfo($_POST['title'], $_POST['recorded_when'], userIdByUser(explode("-and-", $_COOKIE['morgam'])[0]), $ThisFileInfo['playtime_seconds'], $target_file, $ThisFileInfo['filesize'], $ThisFileInfo['mime_type'], $ThisFileInfo['video']['resolution_x'], $ThisFileInfo['video']['resolution_y'], $ThisFileInfo['video']['frame_rate']);
